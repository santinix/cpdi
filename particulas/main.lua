...
local testeParticula = physics.newParticleSystem (
    {
        ...
        -- raius fisico da particula
        radius = 2, 
        -- radius da imagem (usa sempre valor maior q o radius da particula para que elas se sobreponham e traga um efeito visual mais satisfatorio)
        imageRadius = 4
    }
)
...
local function onTimer (event)
   ...
   { -- determina onde a nova partícula é gerada
        ...
        velocityX=256,
        velocityY=480,
        -- define a cor da particula rgba
        color={1, 0.2,0.4,1},
        -- Define o tempo de vida da particula, quantos segundos ela permanece na tela antes de "morrer" (0=infinito)
        lifetime=32.0,
