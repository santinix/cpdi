...
-- Tipos das sementes na plantação
-- Semente1 = terra1 ... 
-- Semente2 = terra2
...
-- local function identTerra (x)
--     if x == 1 then
--         terras = terra1
--         tipoSemente = tipoSemente1
--         statusTerra = statusTerra1
...
local alfacePlacar = display.newImageRect (uiGroup, "imagens/fazendaSprites/fazendaBarra/sementes/alface.png", 36, 33)
alfacePlacar.x, alfacePlacar.y = display.screenOriginX + 30, display.screenOriginY+14

local batataPlacar = display.newImageRect (uiGroup, "imagens/fazendaSprites/fazendaBarra/sementes/batata.png", 36, 33)
batataPlacar.x, batataPlacar.y = display.screenOriginX + 70, display.screenOriginY+14

local trigoPlacar = display.newImageRect (uiGroup, "imagens/fazendaSprites/fazendaBarra/sementes/trigo.png", 36, 33)
trigoPlacar.x, trigoPlacar.y = display.screenOriginX + 112, display.screenOriginY+14

local tomatePlacar = display.newImageRect (uiGroup, "imagens/fazendaSprites/fazendaBarra/sementes/tomate.png", 36, 33)
...
local textoPlacarAlface = display.newText (uiGroup, valorAlface, display.screenOriginX + 30, display.screenOriginY+36, native.systemFont, 18)
textoPlacarAlface:setFillColor (0, 0, 0)


local textoPlacarBatata = display.newText (uiGroup, valorAlface, display.screenOriginX + 70, display.screenOriginY+36, native.systemFont, 18)
textoPlacarBatata:setFillColor (0, 0, 0)

local textoPlacarTrigo = display.newText (uiGroup, valorAlface, display.screenOriginX + 110, display.screenOriginY+36, native.systemFont, 18)
textoPlacarTrigo:setFillColor (0, 0, 0)

local textoPlacarTomate = display.newText (uiGroup, valorAlface, display.screenOriginX + 150, display.screenOriginY+36, native.systemFont, 18)
